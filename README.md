...
**Warning:** This file is overwritten every time you run this.

#### options.processMessage
Type: `Function`
Default value: `_.identity`

Custom function that will process every extracted message before it's included in the PO file. This
...
var locales = ["de-DE", "en-GB", "en-US", "de-DE", "fr-FR", "ja-JP", "nl-NL"];
